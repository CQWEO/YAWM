...
Tab2:Toggle("God Mode","You Can Hidden Rush Ambush But No Hiding In Wardrobe And No Entity Hide.",function()
...
Collison.Position = Collison.Position - Vector3.new(0,10,0)
       if not God Mode then
            Flux:Notification("God Mode On","OK")
            return
        end
    end)
end
...
setreadonly(mt,true)ScreechModule.Parent
